...
outfiles = fullfile(maindir,'params','SR-blocks');
mkdir(outfiles);
...
if rand < 0.5
    block_types1 = [1:4 1:4 ceil(rand*4)]; % skipping block types 4 and 5
    block_types2 = [1:4 1:4 ceil(rand*4)];
else
    block_types2 = [1:4 1:4 ceil(rand*4)];
    block_types1 = [1:4 1:4 ceil(rand*4)];
end
