...
def infotodict(seqinfo):
    ...
    #me1
    rest_mb1me1 =       create_key('sub-{subject}/func/sub-{subject}_acq-mb1me1_task-rest_run-{item:d}_bold')
    rest_mb1me1_sbref = create_key('sub-{subject}/func/sub-{subject}_acq-mb1me1_task-rest_run-{item:d}_sbref')
    rest_mb3me1 =       create_key('sub-{subject}/func/sub-{subject}_acq-mb3me1_task-rest_run-{item:d}_bold')
    rest_mb3me1_sbref = create_key('sub-{subject}/func/sub-{subject}_acq-mb3me1_task-rest_run-{item:d}_sbref')
    rest_mb6me1 =       create_key('sub-{subject}/func/sub-{subject}_acq-mb6me1_task-rest_run-{item:d}_bold')
    rest_mb6me1_sbref = create_key('sub-{subject}/func/sub-{subject}_acq-mb6me1_task-rest_run-{item:d}_sbref')

    #me3
    rest_mb1me3 =       create_key('sub-{subject}/func/sub-{subject}_acq-mb1me3_task-rest_run-{item:d}_bold')
    rest_mb1me3_sbref = create_key('sub-{subject}/func/sub-{subject}_acq-mb1me3_task-rest_run-{item:d}_sbref')
    rest_mb3me3 =       create_key('sub-{subject}/func/sub-{subject}_acq-mb3me3_task-rest_run-{item:d}_bold')
    rest_mb3me3_sbref = create_key('sub-{subject}/func/sub-{subject}_acq-mb3me3_task-rest_run-{item:d}_sbref')
    rest_mb6me3 =       create_key('sub-{subject}/func/sub-{subject}_acq-mb6me3_task-rest_run-{item:d}_bold')
    rest_mb6me3_sbref = create_key('sub-{subject}/func/sub-{subject}_acq-mb6me3_task-rest_run-{item:d}_sbref')
    rest_mb3me3noInt =       create_key('sub-{subject}/func/sub-{subject}_acq-mb6me3noInt_task-rest_run-{item:d}_bold')
    rest_mb3me3noInt_sbref = create_key('sub-{subject}/func/sub-{subject}_acq-mb6me3noInt_task-rest_run-{item:d}_sbref')

    #other
    rest_mb3me4 =       create_key('sub-{subject}/func/sub-{subject}_acq-mb3me4_task-rest_run-{item:d}_bold')
    rest_mb3me4_sbref = create_key('sub-{subject}/func/sub-{subject}_acq-mb3me4_task-rest_run-{item:d}_sbref')
    rest_mb3me3 =       create_key('sub-{subject}/func/sub-{subject}_acq-mb3me3_task-rest_run-{item:d}_bold')
    rest_mb3me3_sbref = create_key('sub-{subject}/func/sub-{subject}_acq-mb3me3_task-rest_run-{item:d}_sbref')
