...
were slice-time corrected to 2.39s (0.5 of slice acquisition range
0s-4.77s) using \texttt{3dTshift} from AFNI
...
0.781s (0.5 of slice acquisition range 0s-1.56s) using \texttt{3dTshift}
